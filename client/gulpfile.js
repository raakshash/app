...
gulp.task('vendor', function() {
  ...
  ]).pipe(gulp.dest('./src/assets/vendor/animate/css'));

});

// Compile SCSS
gulp.task('css:compile', function() {
  return gulp.src('./src/app/landingpage/scss/**/*.scss')
    .pipe(sass.sync({
      outputStyle: 'expanded'
    }).on('error', sass.logError))
    .pipe(gulp.dest('./src/app/landingpage'))
});
...
gulp.task('angular', ['css:compile', 'vendor']);